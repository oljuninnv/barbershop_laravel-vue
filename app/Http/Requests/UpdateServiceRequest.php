...
class UpdateServiceRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'string|max:50', // Имя обязательно, строка, максимум 50 символов
            'price' => 'numeric|min:0', // Цена обязательна, должна быть числом, не меньше 0 и не больше 10000
            'execution_time' => 'date_format:H:i:s', // Время выполнения обязательно, должно соответствовать формату времени
        ];
    }
